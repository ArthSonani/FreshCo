...
export default function Categories() {
    ...
    icons.forEach((icon)=>{
        icon.addEventListener('click', ()=>{
            ...
            icon.classList.add('category-selected')
        })
    })

  return (
    <div className='category-container'>
        <div className='category-icon-container category-selected' id='cat1' onClick={()=>{navigate('/shop/all-stores')}}>
        ...
        <div className='category-icon-container' id='cat2' onClick={()=>{navigate('/shop/groceries-and-food-items')}}>
        ...
        <div className='category-icon-container' id='cat3' onClick={()=>{navigate('/shop/stationery')}}>
        ...
        <div className='category-icon-container' id='cat4' onClick={()=>{navigate('/shop/stores-and-games')}}>
        ...
        <div className='category-icon-container' id='cat5' onClick={()=>{navigate('/shop/pharmacy')}}>
        ...
        <div className='category-icon-container' id='cat6' onClick={()=>{navigate('/shop/personal-care-and-beauty')}}>
        ...
        <div className='category-icon-container' id='cat7' onClick={()=>{navigate('/shop/clothing-and-accessories')}}>
        ...
        <div className='category-icon-container' id='cat8' onClick={()=>{navigate('/shop/household-essentials')}}>
        ...
        <div className='category-icon-container' id='cat9' onClick={()=>{navigate('/shop/electronics-and-gadgets')}}>
        ...
        <div className='category-icon-container' id='cat10' onClick={()=>{navigate('/shop/pet-supplies')}}>
